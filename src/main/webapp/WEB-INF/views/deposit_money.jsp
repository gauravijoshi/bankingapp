...
<body>      
	...
	<c:if test="${error!=null}">
				...
				<c:if test="${param.act eq 'de'}">
				<p class="success">Deposited Successfully</p>
				</c:if> 
				<c:url var="deposit_url" value="/deposit"></c:url> 
    <div class="deposit">    
    <f:form	action='${deposit_url}' modelAttribute="deposit">  
